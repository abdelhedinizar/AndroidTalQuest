...
public class MyPojo
{
    ...
    {
        return "ClassPojo [current_user_repositories_url = "+current_user_repositories_url+", feeds_url = "+feeds_url+", current_user_authorizations_html_url = "+current_user_authorizations_html_url+", user_search_url = "+user_search_url+", team_url = "+team_url+", keys_url = "+keys_url+", commit_search_url = "+commit_search_url+", starred_gists_url = "+starred_gists_url+", following_url = "+following_url+", current_user_url = "+current_user_url+", events_url = "+events_url+", authorizations_url = "+authorizations_url+", user_repositories_url = "+user_repositories_url+", gists_url = "+gists_url+", starred_url = "+starred_url+", issues_url = "+issues_url+", organization_repositories_url = "+organization_repositories_url+", user_url = "+user_url+", user_organizations_url = "+user_organizations_url+", emails_url = "+emails_url+", notifications_url = "+notifications_url+", repository_url = "+repository_url+", code_search_url = "+code_search_url+", organization_url = "+organization_url+", rate_limit_url = "+rate_limit_url+", repository_search_url = "+repository_search_url+", followers_url = "+followers_url+", issue_search_url = "+issue_search_url+", public_gists_url = "+public_gists_url+", emojis_url = "+emojis_url+", hub_url = "+hub_url+"]";
    }
}